...
def get_unique_occupation_text_input_by_sex(data: pd.DataFrame) -> tuple[set[str], set[str]]:
    ...
    father_occupation = set(list(data.loc[(~data["FPCLCALIBELLEMAX"].isna()),"FPCLCALIBELLEMAX"]))
    men_occupation = men_current_occupation | men_secondary_occupation | men_previous_occupation | father_occupation
    ...
    mother_occupation = set(list(data.loc[(~data["MPCLCALIBELLEMAX"].isna()),"MPCLCALIBELLEMAX"]))
    women_occupation = women_current_occupation | women_secondary_occupation | women_previous_occupation | mother_occupation
